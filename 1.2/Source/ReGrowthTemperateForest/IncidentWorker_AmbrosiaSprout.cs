...
namespace ReGrowthTemperateForest
{
	public class IncidentWorker_AlastairusSprout : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			for (int i = 0; i < randomInRange; i++)
			{
				...
				Thing thing2 = GenSpawn.Spawn(DefDatabase<ThingDef>.GetNamed("RG-TF_Alastairus"), result, map);
				if (thing == null)
				{
					thing = thing2;
				}
